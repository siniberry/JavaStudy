...
//		상수 클래스 및 하위 클래스(즉, 상속 관계에 있는 클래스)를 설계하는 과정에서
...
class Rect114 extends SuperTest114
{
	...
	*/
	...
	public Rect114()
	{
		// 자동으로 부모 생성자중 인자없는 생성자 호출하는 구문이 생성
		super();		
		//→ SuperTest114();
	}
...
// main () 메소드를 포함하고 있는 외부의 다른 클래스
	public class Test114
	{
		public static void main(String[]args)
		{
			...
			//--==>> 에러 발생(컴파일 에러)
			//-- 현재 Circle114 클래스레는
			//	 매개변수로 필요로하는 사용자 정의 생성자가 만들어져 있으며
			//	 이로인해 default 생성자가 자동으로 삽입되지 않는 상황
